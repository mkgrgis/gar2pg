...
- Полуавтоматическое (нужно выбрать схему) разворачивание таблиц, соответствующих этим метаданных в выбранной схеме
- Автоматическое создание словарей, указыващих из каких xml и атрибутов в какие таблицы и колонки перегружаются данные
- Автоматическое определние параметров вызова программы перегрузки данных ГАР на основании имени любого XML файла ГАР `load_xml.sh`
- Быстрая перегрузка любых XML данных в PostgreSQL с незначительным потреблением ОЗУ
